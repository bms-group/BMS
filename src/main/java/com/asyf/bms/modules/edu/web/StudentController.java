 ...
 */
package com.asyf.bms.modules.edu.web;
...
import com.asyf.bms.modules.edu.service.StudentService;
 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/edu/student")
public class StudentController extends BaseController {
	...
	public String list(Student student, HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		return "modules/edu/studentList";
	}
	...
	public String form(Student student, Model model) {
		...
		return "modules/edu/studentForm";
	}
	...
	public String save(Student student, Model model, RedirectAttributes redirectAttributes) {
		...
		return "redirect:"+Global.getAdminPath()+"/edu/student/?repage";
	}
